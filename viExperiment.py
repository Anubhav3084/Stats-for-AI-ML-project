...
if __name__ == "__main__" :
	...
	if args.testclass != args.filteredclass :
		...
		with torch.no_grad() :
			...
			plt.title("Seen class probabilities")	
			plt.ylim([0,1])
			plt.xticks(np.arange(10))
			plt.savefig("Seen class probabilities.png")
			...
			plt.title("Seen inner and outter sample std")
			plt.xticks(np.arange(10))
			plt.savefig("Seen inner and outter sample std.png")
	...
	with torch.no_grad() :
		...
		plt.ylabel('digit prob')
		plt.ylim([0,1])
		plt.title("Unseen class probabilities")
		plt.xticks(np.arange(10))
		plt.savefig('Unseen class probabilities.png')
		...
		plt.xlabel('digits')
		plt.ylabel('std digit prob')
		plt.title("Unseen inner and outter sample std")
		plt.xticks(np.arange(10))
		plt.savefig('Unseen inner and outter sample std.png')
	...
	with torch.no_grad() :
		...
		plt.ylabel('digit prob')
		plt.ylim([0,1])
		plt.title("White noise class probabilities")
		plt.xticks(np.arange(10))
		plt.savefig('White noise class probabilities.png')
		...
		plt.xlabel('digits')
		plt.ylabel('std digit prob')
		plt.title("White noise inner and outter sample std")
		plt.xticks(np.arange(10))
		plt.savefig('White noise inner and outter sample std.png')
